...
try:
    ...
    from src.core.tv_mount_optimizer import TVMountOptimizer, MaterialType, LoadCase, LoadType
...
def demo_visualization():
    ...
    # Save mock results
    results_file = 'results/reports/demo_results.json'
    ...
    # List generated files with correct paths
    generated_files = [
        ('results/plots/stress_distribution.png', 'stress_distribution.png'),
        ('results/plots/displacement_analysis.png', 'displacement_analysis.png'), 
        ('results/plots/optimization_convergence.png', 'optimization_convergence.png'),
        ('results/plots/3d_geometry.png', '3d_geometry.png'),
        ('results/plots/optimization_dashboard.html', 'optimization_dashboard.html'),
        ('results/reports/visualization_report.md', 'visualization_report.md')
    ]
    ...
    print("\n💡 Open 'results/plots/optimization_dashboard.html' in browser for interactive exploration!")
    print("\n" + "=" * 50)
