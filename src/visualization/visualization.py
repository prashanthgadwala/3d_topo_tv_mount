...
class ResultsVisualizer:
    ...
    def create_stress_distribution_plot(self, load_case: str = None) -> bool:
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('results/plots/stress_distribution.png', dpi=300, bbox_inches='tight')
    ...
    def create_displacement_analysis(self) -> bool:
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('results/plots/displacement_analysis.png', dpi=300, bbox_inches='tight')
    ...
    def create_optimization_convergence_plot(self) -> bool:
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('results/plots/optimization_convergence.png', dpi=300, bbox_inches='tight')
    ...
    def create_interactive_dashboard(self) -> bool:
        ...
        try:
            ...
            fig.write_html("results/plots/optimization_dashboard.html")
            logger.info("Interactive dashboard created: results/plots/optimization_dashboard.html")
            return True
    ...
    def create_3d_geometry_visualization(self) -> bool:
        ...
        try:
            ...
            plt.savefig('results/plots/3d_geometry.png', dpi=300, bbox_inches='tight')
    ...
    def generate_complete_report(self) -> str:
        ...
        report_filename = "results/reports/visualization_report.md"
